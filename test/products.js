...
describe('MindBody Products', function () {

  it('should return products categories', function (done) {
    cli.getCategories()
        .then(categories => {
  ...
  it('should return product id 1237', function (done) {
    cli.getProduct(1237)
        .then(product => {
  ...
  it('should get all products for category 32', function (done) {
