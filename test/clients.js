...
describe('MindBody Clients', function () {
  it('should return 10 clients', function () {
    return cli.getClients(null, null, 0, 10).should.eventually.have.length(10)
  });

  it('should return second page 10 clients', function () {
    return cli.getClients(null, null, 1, 10).should.eventually.have.length(10)
  });

  it('should search client 100014514', function (done) {
  ...
  it('should return single client 100014514', function (done) {
  ...
  it('should return search demo andrew', function (done) {
